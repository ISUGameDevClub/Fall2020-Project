...
public class SlotOnUse : MonoBehaviour
{
    ...
    private void OnUse()
    {
        if (CurrentWeapon == 0)
        {
            Slots[0].GetComponent<Image>().color = new Color(0, 0, 1, 1);
        }else{
        ...
        if (CurrentWeapon == 1)
        {
            Slots[1].GetComponent<Image>().color = new Color(0, 0, 1, 1);
        }
        else
        {
         ...
         if (CurrentWeapon == 2)
        {
            Slots[2].GetComponent<Image>().color = new Color(0, 0, 1, 1);
        }
        else
        {
         ...
         if (CurrentWeapon == 3)
        {
            Slots[3].GetComponent<Image>().color = new Color(0, 0, 1, 1);
        }else
        {
